...
v3.7.1 patch — Okinawa Receipt Inbox sample + trashed receipt export fix（release preparation 中）
```
...
### v3.7.1 — patch（**release preparation 中**）
...
| **v3.7** | Receipt assign / trash | assign / trash / restore + pending sum + export v8 — **v3.7.0 リリース済み**；v3.7.1 patch（sample + export fix）準備中 |
