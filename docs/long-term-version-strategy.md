...
## v3.3 — Planned vs Actual Difference（**計画中**）
...
設計系列: [v3.3.0-planned-vs-actual-implementation-plan.md](specifications/v3.3.0-planned-vs-actual-implementation-plan.md) → Implementation → Post-Implementation Review → Release v3.3.0。
...
| **v3.3** | Planned vs Actual Difference | Trip 単位の通貨別差分（stats / export-md） |
