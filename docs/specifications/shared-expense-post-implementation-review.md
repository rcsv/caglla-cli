...
| add / update: `--shared-with` と `--beneficiary` 排他 | §Open Q #10 | add / update とも `cannot combine --shared-with and --beneficiary` | ✅ |
...
| add / update 排他 | — | — | `cli_expense_rejects_shared_with_and_beneficiary_on_add`, `cli_expense_rejects_shared_with_and_beneficiary_on_update` | ✅ |
...
| 7 | add / update 排他・update 全置換 | ✅ add/update 排他は PR #40 review 後に update 側も reject 化 |
