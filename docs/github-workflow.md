...
| Milestone | テーマ | 状態 |
|---|---|---|
| **v1 Planning Foundation** | Trip / Day / Itinerary / Ledger 基盤 | v1.23.0 でクローズ |
| **v2 Participant Foundation** | 同行者を Trip に紐付け | 次の主テーマ |
...
documentation-only release でも tag push と Release notes は **必須** です（v1.19–v1.23 と同様）。

---

## v2 Participant Foundation — 推奨 Issue 系列

[planning-foundation-completion-review.md](specifications/planning-foundation-completion-review.md) §9 より:
