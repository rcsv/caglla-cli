...
| [`outputs/02-empty-itinerary.txt`](outputs/02-empty-itinerary.txt) | itinerary 0件 | `No major issues found.` |
...
| [`outputs/06-missing-duration.txt`](outputs/06-missing-duration.txt) | 所要時間未設定 | `Some itineraries have no duration estimate` |
